...
const App = () => {
  const list = [
    ...
    },
    {
      id: "phone",
      lef: "2016",
      rig: "This Was Louise's Phone",
    },
    {
      id: "kikk",
      lef: "2012 - TODAY",
      rig: "KIKK Festival 2018",
    },
    {
      id: "kennedy",
      lef: "2017",
      rig: "The Kennedy Center",
    },
    {
      id: "opera",
      lef: "2016 - ONGOING",
      rig: "Royal Opera Of Wallonia",
    },
  ];
  return (
    <div>
      <main>
        ...
        <section id="section-1" className="z-10">
          <div className=" flex justify-between items-center pr-15 pl-15 py-10">
            <div className="max-w-50 max-h-10">
              <svg
            ...
            <div className="text-white text-[14px]">
              <i className="ri-arrow-right-wide-fill text-orange-600"></i>Our
              Showreel
            </div>
            <div>
              <i className="ri-menu-3-fill text-white text-2xl"></i>
            </div>
          </div>
          <div className="flex">
            {/* left div */}
            <div
              id="one"
              className="w-1/2 max-h-125 text-white text-right text-[125px]/26  flex flex-col items-end justify-baseline pt-17"
            >
              <h1>We</h1>
              <h1>Make</h1>
              <h1>Good</h1>
            ...
            {/* right div */}
            <div className="w-1/2 max-h-125"></div>
          </div>
        </section>
        <section id="section-2">
          <div className="w-full max-h-84 flex mb-40">
            <div className="w-[60%] h-full"></div>
            <div className="w-[40%] h-full">
              <h1 className=" text-[25px] pt-10 pb-5 text-white">
                Dogstudio is a multidisciplinary <br />
                creative studio at the intersection
                <br /> of art, design and technology.
              </h1>
              <p className="text-white opacity-65 text-[15px]/7 pb-15">
        ...
        <section id="section-3">
          <div className="w-full h-10 text-white font-extralight flex justify-start items-start mb-10 opacity-30">
            <div className="w-[10%] pl-5 text-nowrap text-right"></div>
            <div className="w-[90%] text-[12px] align-text-top pl-10">
              FEATURED PROJECTS
            </div>
          </div>
          {list.map((item, index) => (
            <div
              ...
              id="two"
              iid = {item.id}
              className="w-full max-h-30 text-white font-extralight flex justify-start items-start pb-40 opacity-30 hover:opacity-100 transition-all ease-linear three"
            >
              <div className="w-[10%] text-[12px] pl-5 text-nowrap text-right pt-2.5">
                {item.lef}
              </div>
              <div className="w-[90%] h-full text-[84px] align-text-top pl-10  leading-none">
                {item.rig}
              </div>
            </div>
          ))}
        ...
        <section id="section-4">
          ...
          <div className="w-full ">
            <div className="w-1/2 pl-30">
              <p className="pb-10 text-[13px] text-[#A0A8DCB3] opacity-90" style={{ wordSpacing: "0.25rem" }}>THIS IS HOW WE DO IT</p>
              <h1 className="text-[50px]/13 relative z-0 isolate text-white opacity-200"  id="one">We're crafting <br/>emotional<br/> experiences aimed <br />at improving <br /> results</h1>
            </div>
          </div>
        </section>
        <section id="section-5">
        <div className="w-full mt-10 flex justify-center mb-10 text-[#A0A8DCB3] text-[14px]/6.5">
            <div className="w-[45%]"></div>
            <div className="w-[20%]"><p>Dogstudio is a design & <br />technology firm working globally <br />from our offices based in <br />Belgium and Chicago. <br />
...
<p className="pt-7 text-white font-extrabold text-[16px]" style={{ wordSpacing: "0.25rem" }}>Discover our values</p>
</div>
            <div className="w-[20%]">We’re passionate about moving <br />people and solving problems for <br />the likes of Microsoft, The <br />Museum of Science And Industry <br />Of Chicago, The Kennedy Center <br />of Washington, Dragone, Quanta <br />Magazine, and many more.</div>
          </div>
      </section>
      </main>
    </div>
